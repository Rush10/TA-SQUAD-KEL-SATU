...
public class Constants {
	...
	public static final String URL_SILOAM_DATA_UPLOAD_DOC_VALID = "https://dev.ptdika.com/siloam/sales/input/upload/575";
	public static final String URL_SILOAM_DATA_UPLOAD_DOC_INVALID = "https://dev.ptdika.com/siloam/sales/input/upload/545";
	public static final String URL_SILOAM_TTD_DIGITAL_DELETE_AND_UPLOAD = "https://dev.ptdika.com/siloam/sales/input/ttd_digital2/569";
	public static final String URL_SILOAM_TTD_DIGITAL_PREVIEW_UPLOAD_DOK = "https://dev.ptdika.com/siloam/sales/input/ttd_digital2/570";
	public static final String URL_SILOAM_TTD_DIGITAL_EDIT_VALID = "https://dev.ptdika.com/siloam/sales/input/ttd_digital2/568";
