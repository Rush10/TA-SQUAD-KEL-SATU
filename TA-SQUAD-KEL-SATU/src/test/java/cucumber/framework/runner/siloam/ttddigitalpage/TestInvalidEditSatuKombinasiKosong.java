...
public class TestInvalidEditSatuKombinasiKosong {
	...
	public TestInvalidEditSatuKombinasiKosong() {
...
//	public void siloam125_sales_mengakses_halaman_website() {
//		driver.get(Constants.URL_SILOAM);
//		ttdDigital.login(Constants.USERNAME_SALES_SILOAM, Constants.PASSWORD_SALES_SILOAM);
//		ttdDigital.btnLogin();
//		extentTest.log(LogStatus.PASS, "Siloam125 Sales Mengakses Halaman Website");
//	}
//
//	@Then("Siloam125 Validasi Sales Masuk Ke Halaman TTD Digital")
//	public void siloam125_validasi_sales_masuk_ke_halaman_ttd_digital() {
//		extentTest.log(LogStatus.PASS, "Siloam125 Validasi Sales Masuk Ke Halaman TTD Digital");
//	}
	...
	@And("^Siloam125 Sales Melakukan Update Pada (.*), (.*), (.*), (.*), (.*), (.*), (.*), dan (.*)$")
	public void siloam125_sales_melakukan_update_pada_nama_nomor_bpjs_nomor_ktp_address_kota_ktp_faskes_awal_faskes_tujuan_dan_alasan(String nama, String nomBpjs,String nomKtp, String address, String kotaKTP, String faskesAwal, String faskesTujuan, String alasan) throws AWTException {
		if(!nama.equals("")) {
		...
		extentTest.log(LogStatus.PASS, "Siloam125 Sales Melakukan Update Pada nama, nomorBPJS, nomorKTP, address, kotaKTP, faskesAwal, faskesTujuan, dan alasan");
	}

	@And("Siloam125 Sales tekan tombol Simpan")
	public void siloam125_sales_tekan_tombol_simpan() {
		ttdDigital.btnUpdate();
		extentTest.log(LogStatus.PASS, "Siloam125 Sales tekan tombol Simpan");
	}

	@Then("Siloam125 Validasi Pesan Harus Isi Field")
	public void siloam125_validasi_pesan_harus_isi_field() {
...
//		}
		...
		extentTest.log(LogStatus.PASS, "Siloam125 Validasi Pesan Harus Isi Field");
	}
}
